...
[TestFixture]
public class InvoluteFunctionTest
{
    ...
    [Test]
    public void InvoluteFunction()
    {
        var involuteFunction =
            Gear.DataDictionary.RetrieveByName(GearParameterName.InvoluteFunction);
        const double expectedValue = 0.014904d;
        var v = involuteFunction.Calculate(Gear.DataDictionary);
