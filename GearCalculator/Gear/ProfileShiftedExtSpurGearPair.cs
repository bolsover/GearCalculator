...
public sealed class ProfileShiftedExtSpurGearPair : Gear
{
    public readonly List<GearParameterName> Parameters = new()
    {
        ...
        GearParameterName.PseCentreDistanceIncrementFactor,
        ...
        GearParameterName.SumCoefficientProfileShift,
    ...
    public ProfileShiftedExtSpurGearPair()
    {
    ...
    public override void Calculate()
    {
        ...
        CalculateParameterValue(GearParameterName.PseCentreDistanceIncrementFactor);
        ...
        CalculateParameterValue(GearParameterName.SumCoefficientProfileShift);
